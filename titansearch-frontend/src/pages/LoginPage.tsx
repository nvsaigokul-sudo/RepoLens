    ...
    <div className="max-w-md mx-auto mt-24 px-4">
      <div className="bg-titan-card border border-titan-border p-8 rounded-2xl shadow-xl">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-titan-text">Welcome Back</h2>
          <p className="text-xs text-titan-muted mt-1">Access advanced AI features & career evaluation</p>
        </div>
        ...
        <p className="text-center text-xs text-titan-muted mt-6">
          ...
          <button onClick={() => navigate('/register')} className="text-titan-primary hover:underline font-bold">
            Sign Up
          </button>
        </p>
      </div>
